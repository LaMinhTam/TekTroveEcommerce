...
public class WebSecurityConfig {
    ...
    SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/products/edit/**", "/products/save", "/products/check-unique").hasAnyAuthority("Admin", "Salesperson", "Editor")
                        .requestMatchers("/products", "/products/", "/products/detail/**", "/products/page/**").hasAnyAuthority("Admin", "Salesperson", "Editor", "Shipper")
                        .requestMatchers("/products/**", "/products/new", "/products/delete/**").hasAnyAuthority("Admin", "Editor")
